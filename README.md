...
##  Tasks
- **Task 1: DH Parameter Modeling:** Formulated structural parameters using Denavit-Hartenberg convention to map individual transformation matrices between consecutive joint frames.
...
- **Task 3: Inverse Kinematics (IK) :** Built a numerical optimization solver using the Newton-Raphson method. Includes structural robustness via the Moore-Penrose pseudo-inverse. Includes jacobian matrix formulation used with Newton Raphson to find new joint parameters.
